...
""));
        ...
        frame_3->setGeometry(QRect(190, 150, 881, 361));
...
""));
        ...
        emballage = new QComboBox(frame_3);
        emballage->addItem(QString());
        emballage->addItem(QString());
        emballage->addItem(QString());
        emballage->addItem(QString());
        emballage->setObjectName("emballage");
        emballage->setGeometry(QRect(30, 300, 71, 42));
        label_9 = new QLabel(frame_3);
        label_9->setObjectName("label_9");
        label_9->setGeometry(QRect(600, 260, 171, 21));
        points = new QLCDNumber(frame_3);
        points->setObjectName("points");
        points->setGeometry(QRect(610, 290, 64, 23));
        label_16 = new QLabel(frame_3);
        label_16->setObjectName("label_16");
        label_16->setGeometry(QRect(680, 290, 63, 20));
        modifier = new QPushButton(frame_3);
        modifier->setObjectName("modifier");
        modifier->setGeometry(QRect(530, 320, 121, 40));
        annuler = new QPushButton(frame_3);
        annuler->setObjectName("annuler");
        annuler->setGeometry(QRect(760, 320, 121, 40));
        afficher = new QPushButton(frame_3);
        afficher->setObjectName("afficher");
        afficher->setGeometry(QRect(640, 320, 121, 40));
        label_20 = new QLabel(frame_3);
        label_20->setObjectName("label_20");
        label_20->setGeometry(QRect(260, 270, 111, 20));
        totale = new QLCDNumber(frame_3);
        totale->setObjectName("totale");
        totale->setGeometry(QRect(260, 310, 64, 23));
        label_21 = new QLabel(frame_3);
        label_21->setObjectName("label_21");
        label_21->setGeometry(QRect(340, 310, 63, 20));
        frame_2 = new QFrame(page);
        frame_2->setObjectName("frame_2");
        frame_2->setGeometry(QRect(0, 0, 151, 811));
        frame_2->setStyleSheet(QString::fromUtf8("/* Couleur de fond du frame */\n"
"background-color: olive;\n"
"\n"
"/* Bordure fine et arrondie pour un effet moderne */\n"
"border: 1px solid #556B2F; \n"
...
""));
        ...
        afficher1 = new QPushButton(page);
        afficher1->setObjectName("afficher1");
        afficher1->setGeometry(QRect(1080, 550, 141, 31));
        annuler2 = new QPushButton(page);
        annuler2->setObjectName("annuler2");
        annuler2->setGeometry(QRect(1220, 550, 141, 31));
        frame_5 = new QFrame(page);
        frame_5->setObjectName("frame_5");
        frame_5->setGeometry(QRect(1110, 150, 301, 141));
...
""));
        ...
        label_13->setGeometry(QRect(160, 90, 331, 31));
        label_13->setStyleSheet(QString::fromUtf8("font: 16pt \"Segoe UI\";"));
        frame = new QFrame(page);
        frame->setObjectName("frame");
        frame->setGeometry(QRect(150, -1, 1691, 91));
        frame->setStyleSheet(QString::fromUtf8("/* Couleur de fond du frame */\n"
"background-color: olive;\n"
"\n"
"/* Bordure fine et arrondie pour un effet moderne */\n"
"border: 1px solid #556B2F; \n"
...
"}"));
        ...
        analyse = new QPushButton(frame);
        analyse->setObjectName("analyse");
        analyse->setGeometry(QRect(940, 0, 161, 91));
        pdf = new QPushButton(frame);
        pdf->setObjectName("pdf");
        pdf->setGeometry(QRect(1260, 0, 171, 91));
        label_18 = new QLabel(frame);
        label_18->setObjectName("label_18");
        label_18->setGeometry(QRect(-10, 0, 361, 91));
        chatbot = new QPushButton(frame);
        chatbot->setObjectName("chatbot");
        chatbot->setGeometry(QRect(1100, 0, 161, 91));
        recherche = new QLineEdit(frame);
        recherche->setObjectName("recherche");
        recherche->setGeometry(QRect(460, 30, 241, 26));
        recherche_2 = new QPushButton(frame);
        recherche_2->setObjectName("recherche_2");
        recherche_2->setGeometry(QRect(710, 30, 71, 21));
...
""));
        ...
        historique = new QPushButton(frame_6);
        historique->setObjectName("historique");
        historique->setGeometry(QRect(720, 0, 261, 91));
        ...
        classement = new QPushButton(frame_6);
        classement->setObjectName("classement");
        classement->setGeometry(QRect(980, 0, 241, 91));
...
""));
        ...
        menubar->setGeometry(QRect(0, 0, 1780, 26));
...
"Par o\303\271 commencer ?", nullptr));
        ...
        emballage->setItemText(0, QCoreApplication::translate("client", "5L", nullptr));
        emballage->setItemText(1, QCoreApplication::translate("client", " 3L", nullptr));
        emballage->setItemText(2, QCoreApplication::translate("client", "1L", nullptr));
        emballage->setItemText(3, QCoreApplication::translate("client", " autre", nullptr));
        ...
        afficher->setText(QCoreApplication::translate("client", " \342\234\224\357\270\217\342\200\213 afficher", nullptr));
        ...
        afficher1->setText(QCoreApplication::translate("client", "\342\234\205 afficher", nullptr));
        annuler2->setText(QCoreApplication::translate("client", "\342\235\214\342\200\213 annuler", nullptr));
        ...
        label_13->setText(QCoreApplication::translate("client", " bienvenue!", nullptr));
        ...
        recherche_2->setText(QCoreApplication::translate("client", "\360\237\224\215\342\200\213", nullptr));
